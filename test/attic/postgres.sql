...
--
-- Name: Country_code; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: ProductCategory_id; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "ProductCategory"
    ADD CONSTRAINT "ProductCategory_id" PRIMARY KEY (id);
...
--
-- Name: Address_customerId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "Address"
    ADD CONSTRAINT "Address_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Customer"(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "Product"
    ADD CONSTRAINT "Product_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "ProductCategory"(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
